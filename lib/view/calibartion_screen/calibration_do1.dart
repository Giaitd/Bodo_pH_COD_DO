...
class CalibrationDO1 extends StatefulWidget {
  const CalibrationDO1({Key? key}) : super(key: key);

  @override
  State<CalibrationDO1> createState() => _CalibrationDO1State();
}

class _CalibrationDO1State extends State<CalibrationDO1> {
  ...
  void initState() {
    ...
    timer4 = Timer.periodic(const Duration(seconds: 1), (timer) {
      calibrationService.calibrationDO1();
      calibrationService.calibDO1Zero.value = false;
      calibrationService.calibDO1Slope.value = false;
    });
  }
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (text) {
                              if (double.parse(text) < -100 ||
                                ...
                                homePageService.offsetDO1.value =
                                    double.parse(text);
                            ...
                            decoration: InputDecoration(
                                ...
                                filled: true,
                                hintText: homePageService.mapSetup["offsetDO1"],
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (homePageService.lockDevice.value == false) {
                            setState(() {
                              calibrationService.calibDO1Zero.value = true;
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.bold,
                                    color:
                                        calibrationService.calibDO1Zero.value ==
                                                true
                                            ? Colors.red
                                            : Colors.white),
                              ),
                    ...
                    child: Column(children: [
                      ElevatedButton(
                        onPressed: () {
                          if (homePageService.lockDevice.value == false) {
                            setState(() {
                              calibrationService.calibDO1Slope.value = true;
                              homePageService.lockDevice.value = true;
                            });
                          } else {
                            showNotification();
